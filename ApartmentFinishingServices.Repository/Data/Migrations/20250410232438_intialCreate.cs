        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerSuggestedPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    WorkerSuggestedPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    FinalAgreedPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    NegotiationStatus = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PortfolioImages_PortfolioItems_PortfolioId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AvailableDays_WorkerId",
                table: "AvailableDays",
                column: "WorkerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PortfolioItems_WorkerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SavedWorkers_CustomerId_ProviderId",
                table: "SavedWorkers",
                columns: new[] { "CustomerId", "ProviderId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SavedWorkers_ProviderId",
                table: "SavedWorkers",
                column: "ProviderId");
