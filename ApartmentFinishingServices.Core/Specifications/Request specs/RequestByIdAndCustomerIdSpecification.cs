...
{
    public class RequestByIdAndCustomerIdSpecification : BaseSpecifications<Request>
    {
        public RequestByIdAndCustomerIdSpecification(int requestId, int customerId)
            : base(r => r.Id == requestId && r.CustomerId == customerId)
        {
            AddIncludes();
        }
